...
#PCA
set.seed(20)
CFTR2.pca <- prcomp(mean_2hours[,4:9], center = TRUE, scale. = TRUE)
...
CFTR2_clusters <-kmeans(mean_2hours[,4:9], best.k, nstart = 20)
CFTR2_clusters 
...
correlations = as.data.frame(cor(mean_2hours[,4:9], CFTR2.pca$x))
...
arrows2 = data.frame(x1 = c(0, 0, 0, 0, 0, 0), y1 = c(0, 0, 0, 0, 0, 0), x2 = correlations$PC1, 
                    y2 = correlations$PC3)
...
arrows3 = data.frame(x1 = c(0, 0, 0, 0, 0, 0), y1 = c(0, 0, 0, 0, 0, 0), x2 = correlations$PC2, 
                     y2 = correlations$PC3)
...
Cirlce_plot <- ggplotly(Cirlce_plot)
Cirlce_plot2 <- ggplotly(Cirlce_plot2)
Cirlce_plot3 <- ggplotly(Cirlce_plot3)
